...
function Home() {
  return <main className="overflow-x-clip bg-[#151514] text-[#e9e6df]">
    ...
    <section className="grid border-b border-white/15 md:min-h-[430px] md:grid-cols-[42%_1fr]"><div className="h-[330px] overflow-hidden bg-[#111] md:h-auto"><img src={heroPortrait} alt="Shawn in the studio" className="h-full w-full object-cover object-[center_45%] grayscale" /></div><div className="flex flex-col items-start justify-center p-8 md:px-[clamp(45px,8vw,130px)]"><span className={eyebrow}>Your story, beautifully told</span><h2 className="my-4 font-display text-5xl leading-none tracking-[-.04em] md:text-7xl">Let’s Create<br />Something Memorable.</h2><p className="mb-8 max-w-md text-sm leading-6 text-[#aaa69d]">Have a project in mind? I’d love to hear about it and bring your vision to life.</p><a href="mailto:camarashawnjames@gmail.com" className={button}>Let’s work together <ArrowRight size={15} /></a></div></section>
    <Footer />
  </main>
}
